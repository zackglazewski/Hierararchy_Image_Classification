...
import copy
from tree import *
from LCALoss import LCAHeavyParentLoss, LCAHeavyChildLoss, LCAEdgeLoss
#TODO:
experiment_path = "./totalPenalty/"
...
# criterion = LCAHeavyChildLoss(classes, clamp_loss=True, greedy=True)
criterion = LCAEdgeLoss(classes, clamp_loss=False)
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for inputs, labels in tqdm(dataloaders[phase]):
                ...
                final_predictions = taxonomy.max_probability_path_batched(outputs)[0]
                # statistics
...
for data, target in tqdm(test_loader):
    ...
    final_predictions = taxonomy.max_probability_path_batched(output)[0]
