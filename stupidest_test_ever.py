...
def train_model(model, criterion, optimizer, num_epochs=25):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model.state_dict(), "vanilla_bce_new_best.pth".format(epoch))
    ...
    torch.save(model.state_dict(), "vanilla_bce_new/vanilla_bce_new_checkpoint{}.pth".format(epoch))
...
torch.save(model.state_dict(), "vanilla_bce_new_last.pth")
